...
help:
	...
	@echo "  windforce-sync         prepare a validated execution bundle for numeric WF_GIT_SOURCE_ID"
	@echo "  windforce-deploy       activate a READY candidate for WF_GIT_SOURCE_ID"
