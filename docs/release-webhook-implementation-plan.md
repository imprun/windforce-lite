...
- 상태: Windforce Lite scope complete ([#76](https://github.com/imprun/windforce-lite/issues/76))
...
- 상태: Completed ([transactional store #69](https://github.com/imprun/windforce-lite/issues/69))
...
- 상태: Completed ([#73](https://github.com/imprun/windforce-lite/issues/73))
...
- 상태: Completed ([#74](https://github.com/imprun/windforce-lite/issues/74))
...
- 상태: Completed ([#75](https://github.com/imprun/windforce-lite/issues/75))
...
- 상태: Windforce Lite contract completed ([#76](https://github.com/imprun/windforce-lite/issues/76))
