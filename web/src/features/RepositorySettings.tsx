      ...
      >
        <DefinitionList
          items={[
            ...
            ["Last release commit", source.last_synced_commit ? shortSHA(source.last_synced_commit, 16) : "Not released"],
          ]}
        />
        ...
        <div className="repositoryActions" aria-label="Repository management actions">
          ...
          <RepositoryActionRow
            ...
            value={locationLocked ? "Locked after first release" : "Editable before first release"}
